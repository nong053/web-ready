...
function postResult(txt){
	...
	xmlReq.send("cat_webdir_title="+document.form1.cat_webdir_title.value+"&cat_webdir_detail="+document.form1.cat_webdir_detail.value+"&action="+document.form1.action.value);
