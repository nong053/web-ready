...
<table cellpadding="0" cellspacing="0" width="100%">
	...
	?>  		
        		...
        		<td><center>
       			...
       			<td>
        		<img src="<?=$thumbnailsFile?>" width="50%" />
                ...
                <a href="index.php?page=news_system&select_news=new_it&news_id=<?=$rs[news_id]?>&action2=edit&news_cat_id=<?=$rs[news_cat_id]?>">
                <img src="images/b_edit.png"  border="0"/>
        		แก้ไขข้อมูล
                </a>
                <a onClick="return confirm('คุณต้องการลบข้อมูลนี้ ?');" href="news_process.php?actionget=del&news_id=<?=$rs[news_id]?>&news_cat_id=<?=$rs[news_cat_id]?>&select_news=new_it">
...
<table>
	<tr>
    	<td>
		<? $numpu=pu_pageloop("news_cat_id=".$news_cat_id."&select_news=new_it"); ?>
        </td>
    </tr>
</table>
<br style="clear:both" />
...
<input type="hidden" name="select_page" value="<?=$select_news?>" />
<?
if($action2=="edit"){
?>
