...
<div class="bg_admin">
	<div id="box_admin">
        ...
        <?
		$select_mlm=$_GET['select_mlm'];
		switch($select_mlm){
			case'member_add' :$select1="select";break;
			case'downline' :$select2="select";break;
        ...
        <div id="bg_bt">
         	...
         	<ul>
            		<li>
                		<div id="<?=$select1?>">
              		 		<a href="index.php?page=mlm_system&select_mlm=mlm">
		...
		switch($select_mlm){
			case'mlm':include("mlm.php");break;
			case'mlm_detail':include("mlm_detail.php");break;
			case'mlm_downline':include("mlm_downline.php");break;
			
			default:include("mlm.php");
			break;
		}
		?>
            </div>
