...
$strSQL="insert into cat_webdir(cat_webdir_title,cat_webdir_detail)values('$cat_webdir_title','$cat_webdir_detail')";
...
$strSQL="update cat_webdir set cat_webdir_title='$cat_webdir_title',cat_webdir_detail='$cat_webdir_detail' where cat_webdir_id='$cat_webdir_id'";
$result=mysql_query($strSQL);
