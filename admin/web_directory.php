...
<div class="bg_admin">
	<div id="box_admin">
		...
		switch($select_page){
			...
			case'verifynewweb' :$select1="select";break;
			case'webdircat_add' :$select2="select";break;
			case'webdircat_edit_del' :$select3="select";break;
			case'webdir_add' :$select4="select";break;
			case'webdir_edit_del' :$select5="select";break;
        ...
        <div id="bg_bt">
         	...
         	<ul>
            		<li>
                		<div id="<?=$select1?>">
              		 		<a href="index.php?page=web_directory&select_page=verifynewweb">
                     ...
                     <li>
                		<div id="<?=$select2?>">
              		 		<a href="index.php?page=web_directory&select_page=webdircat_add">
                            <div id="devmagin" style="margin:5px;">
              			 	เพิ่มหมวด
                     		</div>
              			 	</a>
                     ...
                     <li>
                		<div id="<?=$select3?>">
              		 		<a href="index.php?page=web_directory&select_page=webdircat_edit_del">
                            <div id="devmagin" style="margin:5px;">
              			 	แก้ไข / ลบ หมวด
                     		</div>
              			 	</a>
                     ...
                     <li>
                		<div id="<?=$select4?>">
              		 		<a href="index.php?page=web_directory&select_page=webdir_add">
                            <div id="devmagin" style="margin:5px;">
              			 	เพิ่มเว็บ
                     		</div>
              			 	</a>
                     ...
                     <li>
                		<div id="<?=$select5?>">
              		 		<a href="index.php?page=web_directory&select_page=webdir_edit_del">
                            <div id="devmagin" style="margin:5px;">
              			 	แก้ไข / ลบ เว็บ
                     		</div>
              			 	</a>
		...
		switch($select_page){
			...
			case'webdircat_add' :include("webdircat_add.php");break;
			case'webdircat_edit_del':include("webdircat_edit_del.php");break;
			case'webdir_add' :include("webdir_add.php");break;
			case'webdir_edit_del':include("webdir_edit_del.php");break;			
